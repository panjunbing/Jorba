...
public class FaceParser {
	private static final String TAG = FaceParser.class.getSimpleName();

	private FaceParser(Context mContext) {
		readMap(mContext);
	}
	...
	private static FaceParser mParser;

	public static FaceParser getInstance(Context mContext) {
		if (mParser == null) {
			mParser = new FaceParser(mContext);
		}
		return mParser;
	}
