...
public class UndercoverActivity2 extends Activity {
...
//    private int player[];
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_wodi2);
		relativeLayout=(RelativeLayout)findViewById(R.id.relativeLayout_wodi2);
...
//		player=new int [number];
	    ...
	    previousButton.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
			Intent intent=new Intent(UndercoverActivity2.this,UndercoverActivity.class);
	    ...
	    thenextButton.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent=new Intent(UndercoverActivity2.this,UndercoverActivity3.class);
